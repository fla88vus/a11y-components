...
export const Disabled: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Radio button disabilitato. Non può essere selezionato o modificato dall'utente.",
      },
    },
  },
};
...
export const WithHelperText: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Radio button con testo di aiuto contestuale. Collegato via `aria-describedby`.",
      },
    },
  },
};
...
export const SubscriptionPlanSelector: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Esempio reale: selettore di piani di abbonamento con card cliccabili.",
      },
    },
  },
};
...
export const ShippingMethodSelector: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Esempio reale: selettore metodo di spedizione in un checkout e-commerce.",
      },
    },
  },
};
...
export const PaymentMethodSelector: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Esempio reale: selettore metodo di pagamento con un'opzione disabilitata.",
      },
    },
  },
};
